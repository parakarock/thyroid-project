 ...
 */
  ...
  getImagePath(imageName) {
    ...
    return path;
    // this.myCanvas = this.getImagePath(imageName);
  }
  ...
  uploadImage(){
    ...
    fileTransfer.upload(this.myCanvas, 'http://10.80.82.229:8000/upload.php', options)
      .then((data) => {
      alert("อัพโหลดรูปวาดเสร็จสมบูรณ์");
      ...
      alert("เกิดข้อผิดพลาดในการอัพโหลด กรุณาทำรายการใหม่อีกครั้ง"+ JSON.stringify(err, Object.getOwnPropertyNames(err)));
      loader.dismiss();
    });
    }
